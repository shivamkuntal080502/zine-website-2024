        ...
        <div className="text-black bg-white justify-center pb-16">
            ...
            <div className="pt-16 grid grid-cols-1 lg:grid-cols-2 px-12 lg:px-24">
                <div className="col-span-1 w-48 member-hover lg:w-80 justify-self-center">
                    <Image className="rounded-full" src={RajeshSir} alt="Dr. Rajesh Kumar" placeholder="blur" />
                    <div className="text-center grid mt-4 justify-evenly grid-cols-3">
                        <div className="cursor-pointer transform-gpu transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                            <Link href="https://drrajeshkumar.wordpress.com/">
                                <FontAwesomeIcon icon={faWordpress} className="text-black mr-4" size="2x" />
                            </Link>
                        </div>
                        <div className="cursor-pointer transform-gpu transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                            <Link href="https://www.linkedin.com/in/drrajeshkumar/">
                                <FontAwesomeIcon icon={faLinkedin} className="text-blue-600 mr-4" size="2x" />
                            </Link>
                        </div>
                        <div className="cursor-pointer transform-gpu transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                            <Link href="https://www.facebook.com/rkumar.ee">
                                <FontAwesomeIcon icon={faFacebook} className="text-blue-800 mr-4" size="2x" />
                            </Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div key={index} className="col-span-1">
                        <h1 className="text-black py-2 font-nunito text-center">
                            <div className="w-48 mx-auto member-hover">
                                <Image className="rounded-full" src={item.image} alt={item.name} placeholder="blur" />
                            </div>
                            ...
                            <div className="text-center">
                                <div className="grid grid-flow-col auto-cols-auto w-64 mt-2 mx-auto justify-evenly px-8">
                                    {item.github && <div className="cursor-pointer transform-gpu transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"><Link href={item.github}><FontAwesomeIcon icon={faGithub} className="text-black mr-4" size="2x" /></Link></div>}
                                    ...
                                    {item.instagram && <div className="cursor-pointer transform-gpu transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"><Link href={item.instagram}><FontAwesomeIcon icon={faInstagram} className="text-red-500 mr-4" size="2x" /></Link></div>}
            ...
            <h1 className="pt-12 text-center font-bold text-4xl px-12 lg:px-24">FIRST YEAR</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 pt-16 px-12 lg:px-24">
